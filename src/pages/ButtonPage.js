    ...
    >
      ...
      <div className="grid grid-cols-2 h-screen relative">
        ...
        <div className="px-8 py-10">
          <Editor onClick={()=>setModel(true)} name={"Button"} />
          <CssButton>
          ...
          {Model && <Modal toggleModal={()=>setModel(false)}>
            <div className="p-5">
              <div className="flex items-center gap-2">
                <p className="text-lime-500 tracking-wider">.button</p>
              ...
              <div className="mx-8 space-y-1">
                ...
                <CssText name={"background-color"} value={`${data.bgColor}`} />
                {data.borderRange > 0 && (
                  <CssText
                    name={"border"}
